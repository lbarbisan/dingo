...
public class LexerDataTable {
  public static final LexerTable<RuleEnum> table;  static {    boolean[] spaceMainAccepts = {true};
    ...
    int[][] commentMainTransitions = {{0,-1,47,2,48,-1},{0,-1,10,5,11,-1,13,4,14,-1},{0,1},{0,-1,47,0,48,-1},{0,-1,10,5,11,-1},{0,-1}};
    ...
    int[][] string_typeMainTransitions = {{0,-1,105,3,106,-1},{0,-1,114,0,115,-1},{0,-1,103,6,104,-1},{0,-1,110,2,111,-1},{0,-1,83,5,84,-1},{0,-1,116,1,117,-1},{0,-1}};
    ...
    int[][] numeric_typeMainTransitions = {{0,-1,114,4,115,-1},{0,-1,78,3,79,-1},{0,-1,101,0,102,-1},{0,-1,117,6,118,-1},{0,-1,105,5,106,-1},{0,-1,99,7,100,-1},{0,-1,109,2,110,-1},{0,-1}};
    CharRegexTable numeric_typeMain = new CharRegexTable(1,numeric_typeMainTransitions,numeric_typeMainAccepts);
    ...
    int[][] function_typeMainTransitions = {{0,-1,116,6,117,-1},{0,-1,110,5,111,-1},{0,-1,110,8,111,-1},{0,-1,111,2,112,-1},{0,-1,70,7,71,-1},{0,-1,99,0,100,-1},{0,-1,105,3,106,-1},{0,-1,117,1,118,-1},{0,-1}};
    CharRegexTable function_typeMain = new CharRegexTable(4,function_typeMainTransitions,function_typeMainAccepts);
    ...
    int[][] object_typeMainTransitions = {{0,-1,106,5,107,-1},{0,-1,79,3,80,-1},{0,-1,116,6,117,-1},{0,-1,98,0,99,-1},{0,-1,99,2,100,-1},{0,-1,101,4,102,-1},{0,-1}};
    CharRegexTable object_typeMain = new CharRegexTable(1,object_typeMainTransitions,object_typeMainAccepts);
    ...
    int[][] array_typeMainTransitions = {{0,-1,97,4,98,-1},{0,-1,114,0,115,-1},{0,-1,65,3,66,-1},{0,-1,114,1,115,-1},{0,-1,121,5,122,-1},{0,-1}};
    ...
    int[][] eolnMainTransitions = {{0,-1,10,2,11,-1,13,1,14,-1},{0,-1,10,2,11,-1},{0,-1}};
    CharRegexTable eolnMain = new CharRegexTable(0,eolnMainTransitions,eolnMainAccepts);
    RuleData eoln=new RuleData(eolnMain,null,false);
    boolean[] dingoMainAccepts = {false,false,false,false,false,false,true};
    int[][] dingoMainTransitions = {{0,-1,64,3,65,-1},{0,-1,110,5,111,-1},{0,-1,111,6,112,-1},{0,-1,100,4,101,-1},{0,-1,105,1,106,-1},{0,-1,103,2,104,-1},{0,-1}};
    ...
    int[][] argsMainTransitions = {{0,-1,103,4,104,-1},{0,-1,114,0,115,-1},{0,-1,64,3,65,-1},{0,-1,97,1,98,-1},{0,-1,115,5,116,-1},{0,-1}};
    ...
    int[][] _varMainTransitions = {{0,-1,97,1,98,-1},{0,-1,114,4,115,-1},{0,-1,64,3,65,-1},{0,-1,118,0,119,-1},{0,-1}};
    CharRegexTable _varMain = new CharRegexTable(2,_varMainTransitions,_varMainAccepts);
    RuleData _var=new RuleData(_varMain,null,false);
    boolean[] _returnMainAccepts = {false,false,false,false,false,false,false,true};
    int[][] _returnMainTransitions = {{0,-1,114,3,115,-1},{0,-1,64,0,65,-1},{0,-1,117,4,118,-1},{0,-1,101,6,102,-1},{0,-1,114,5,115,-1},{0,-1,110,7,111,-1},{0,-1,116,2,117,-1},{0,-1}};
    CharRegexTable _returnMain = new CharRegexTable(1,_returnMainTransitions,_returnMainAccepts);
    RuleData _return=new RuleData(_returnMain,null,false);
    boolean[] _ifMainAccepts = {false,false,false,true};
    int[][] _ifMainTransitions = {{0,-1,105,2,106,-1},{0,-1,64,0,65,-1},{0,-1,102,3,103,-1},{0,-1}};
    ...
    int[][] _elseMainTransitions = {{0,-1,101,2,102,-1},{0,-1,64,0,65,-1},{0,-1,108,3,109,-1},{0,-1,115,4,116,-1},{0,-1,101,5,102,-1},{0,-1}};
    ...
    int[][] _forMainTransitions = {{0,-1,111,1,112,-1},{0,-1,114,4,115,-1},{0,-1,102,0,103,-1},{0,-1,64,2,65,-1},{0,-1}};
    ...
    int[][] _foreachMainTransitions = {{0,-1,64,5,65,-1},{0,-1,97,4,98,-1},{0,-1,104,8,105,-1},{0,-1,111,6,112,-1},{0,-1,99,2,100,-1},{0,-1,102,3,103,-1},{0,-1,114,7,115,-1},{0,-1,101,1,102,-1},{0,-1}};
    CharRegexTable _foreachMain = new CharRegexTable(0,_foreachMainTransitions,_foreachMainAccepts);
    ...
    int[][] foreverMainTransitions = {{0,-1,101,2,102,-1},{0,-1,118,0,119,-1},{0,-1,114,8,115,-1},{0,-1,64,5,65,-1},{0,-1,101,1,102,-1},{0,-1,102,7,103,-1},{0,-1,114,4,115,-1},{0,-1,111,6,112,-1},{0,-1}};
    CharRegexTable foreverMain = new CharRegexTable(3,foreverMainTransitions,foreverMainAccepts);
    RuleData forever=new RuleData(foreverMain,null,false);
    boolean[] _breakMainAccepts = {false,false,false,false,false,false,true};
    int[][] _breakMainTransitions = {{0,-1,114,5,115,-1},{0,-1,97,2,98,-1},{0,-1,107,6,108,-1},{0,-1,98,0,99,-1},{0,-1,64,3,65,-1},{0,-1,101,1,102,-1},{0,-1}};
    ...
    int[][] _continueMainTransitions = {{0,-1,105,1,106,-1},{0,-1,110,5,111,-1},{0,-1,101,9,102,-1},{0,-1,64,7,65,-1},{0,-1,116,0,117,-1},{0,-1,117,2,118,-1},{0,-1,111,8,112,-1},{0,-1,99,6,100,-1},{0,-1,110,4,111,-1},{0,-1}};
    CharRegexTable _continueMain = new CharRegexTable(3,_continueMainTransitions,_continueMainAccepts);
    ...
    int[][] printMainTransitions = {{0,-1,110,2,111,-1},{0,-1,114,4,115,-1},{0,-1,116,6,117,-1},{0,-1,112,1,113,-1},{0,-1,105,0,106,-1},{0,-1,64,3,65,-1},{0,-1}};
    ...
    int[][] printlnMainTransitions = {{0,-1,105,3,106,-1},{0,-1,114,0,115,-1},{0,-1,110,8,111,-1},{0,-1,110,5,111,-1},{0,-1,64,7,65,-1},{0,-1,116,6,117,-1},{0,-1,108,2,109,-1},{0,-1,112,1,113,-1},{0,-1}};
    ...
    int[][] _nullMainTransitions = {{0,-1,78,1,79,-1},{0,-1,85,2,86,-1},{0,-1,76,4,77,-1},{0,-1,64,0,65,-1},{0,-1,76,5,77,-1},{0,-1}};
    ...
    int[][] guiMainTransitions = {{0,-1,64,2,65,-1},{0,-1,105,4,106,-1},{0,-1,103,3,104,-1},{0,-1,117,1,118,-1},{0,-1}};
    CharRegexTable guiMain = new CharRegexTable(0,guiMainTransitions,guiMainAccepts);
    RuleData gui=new RuleData(guiMain,null,false);
    boolean[] _voidMainAccepts = {false,false,false,false,true};
    int[][] _voidMainTransitions = {{0,-1,111,3,112,-1},{0,-1,100,4,101,-1},{0,-1,118,0,119,-1},{0,-1,105,1,106,-1},{0,-1}};
    CharRegexTable _voidMain = new CharRegexTable(2,_voidMainTransitions,_voidMainAccepts);
