...
public class LexerDataTable {
  public static final LexerTable<RuleEnum> table;  static {    boolean[] spaceMainAccepts = {true};
    ...
    boolean[] commentMainAccepts = {false,false,false,false,false,false,true};
    int[][] commentMainTransitions = {{0,-1,47,3,48,-1},{0,1,10,6,11,1,13,2,14,1},{0,-1,10,6,11,-1},{0,-1,42,4,43,-1,47,1,48,-1},{0,4,42,5,43,4},{0,-1,47,6,48,-1},{0,-1}};
    CharRegexTable commentMain = new CharRegexTable(0,commentMainTransitions,commentMainAccepts);
    ...
    int[][] stringValueMainTransitions = {{0,0,34,2,35,0},{0,-1,34,0,35,-1},{0,0,34,2,35,0}};
    ...
    int[][] string_typeMainTransitions = {{0,-1,116,1,117,-1},{0,-1,114,5,115,-1},{0,-1,103,6,104,-1},{0,-1,110,2,111,-1},{0,-1,83,0,84,-1},{0,-1,105,3,106,-1},{0,-1}};
    CharRegexTable string_typeMain = new CharRegexTable(4,string_typeMainTransitions,string_typeMainAccepts);
    ...
    int[][] numeric_typeMainTransitions = {{0,-1,101,2,102,-1},{0,-1,105,5,106,-1},{0,-1,114,1,115,-1},{0,-1,109,0,110,-1},{0,-1,117,3,118,-1},{0,-1,99,7,100,-1},{0,-1,78,4,79,-1},{0,-1}};
    CharRegexTable numeric_typeMain = new CharRegexTable(6,numeric_typeMainTransitions,numeric_typeMainAccepts);
    ...
    int[][] function_typeMainTransitions = {{0,-1,117,1,118,-1},{0,-1,110,5,111,-1},{0,-1,110,8,111,-1},{0,-1,105,4,106,-1},{0,-1,111,2,112,-1},{0,-1,99,6,100,-1},{0,-1,116,3,117,-1},{0,-1,70,0,71,-1},{0,-1}};
    ...
    int[][] object_typeMainTransitions = {{0,-1,79,4,80,-1},{0,-1,101,3,102,-1},{0,-1,116,6,117,-1},{0,-1,99,2,100,-1},{0,-1,98,5,99,-1},{0,-1,106,1,107,-1},{0,-1}};
    CharRegexTable object_typeMain = new CharRegexTable(0,object_typeMainTransitions,object_typeMainAccepts);
    ...
    int[][] array_typeMainTransitions = {{0,-1,114,1,115,-1},{0,-1,97,4,98,-1},{0,-1,65,3,66,-1},{0,-1,114,0,115,-1},{0,-1,121,5,122,-1},{0,-1}};
    CharRegexTable array_typeMain = new CharRegexTable(2,array_typeMainTransitions,array_typeMainAccepts);
    ...
    int[][] dingoMainTransitions = {{0,-1,100,1,101,-1},{0,-1,105,5,106,-1},{0,-1,111,6,112,-1},{0,-1,64,0,65,-1},{0,-1,103,2,104,-1},{0,-1,110,4,111,-1},{0,-1}};
    CharRegexTable dingoMain = new CharRegexTable(3,dingoMainTransitions,dingoMainAccepts);
    RuleData dingo=new RuleData(dingoMain,null,false);
    boolean[] argsMainAccepts = {false,false,false,false,false,true};
    int[][] argsMainTransitions = {{0,-1,114,3,115,-1},{0,-1,97,0,98,-1},{0,-1,64,1,65,-1},{0,-1,103,4,104,-1},{0,-1,115,5,116,-1},{0,-1}};
    CharRegexTable argsMain = new CharRegexTable(2,argsMainTransitions,argsMainAccepts);
    RuleData args=new RuleData(argsMain,null,false);
    boolean[] defMainAccepts = {false,false,false,false,true};
    int[][] defMainTransitions = {{0,-1,100,3,101,-1},{0,-1,102,4,103,-1},{0,-1,64,0,65,-1},{0,-1,101,1,102,-1},{0,-1}};
    CharRegexTable defMain = new CharRegexTable(2,defMainTransitions,defMainAccepts);
    RuleData def=new RuleData(defMain,null,false);
    boolean[] _varMainAccepts = {false,false,false,false,true};
    int[][] _varMainTransitions = {{0,-1,64,3,65,-1},{0,-1,114,4,115,-1},{0,-1,97,1,98,-1},{0,-1,118,2,119,-1},{0,-1}};
    CharRegexTable _varMain = new CharRegexTable(0,_varMainTransitions,_varMainAccepts);
    RuleData _var=new RuleData(_varMain,null,false);
    boolean[] _returnMainAccepts = {false,false,false,false,false,false,false,true};
    int[][] _returnMainTransitions = {{0,-1,117,6,118,-1},{0,-1,114,2,115,-1},{0,-1,101,4,102,-1},{0,-1,64,1,65,-1},{0,-1,116,0,117,-1},{0,-1,110,7,111,-1},{0,-1,114,5,115,-1},{0,-1}};
    ...
    int[][] _elseMainTransitions = {{0,-1,108,1,109,-1},{0,-1,115,4,116,-1},{0,-1,101,0,102,-1},{0,-1,64,2,65,-1},{0,-1,101,5,102,-1},{0,-1}};
    ...
    int[][] _forMainTransitions = {{0,-1,64,2,65,-1},{0,-1,114,4,115,-1},{0,-1,102,3,103,-1},{0,-1,111,1,112,-1},{0,-1}};
    CharRegexTable _forMain = new CharRegexTable(0,_forMainTransitions,_forMainAccepts);
    ...
    int[][] _foreachMainTransitions = {{0,-1,102,7,103,-1},{0,-1,114,5,115,-1},{0,-1,104,8,105,-1},{0,-1,99,2,100,-1},{0,-1,64,0,65,-1},{0,-1,101,6,102,-1},{0,-1,97,3,98,-1},{0,-1,111,1,112,-1},{0,-1}};
    CharRegexTable _foreachMain = new CharRegexTable(4,_foreachMainTransitions,_foreachMainAccepts);
    RuleData _foreach=new RuleData(_foreachMain,null,false);
    boolean[] _inMainAccepts = {false,false,false,true};
    int[][] _inMainTransitions = {{0,-1,105,2,106,-1},{0,-1,64,0,65,-1},{0,-1,110,3,111,-1},{0,-1}};
    CharRegexTable _inMain = new CharRegexTable(1,_inMainTransitions,_inMainAccepts);
    ...
    int[][] foreverMainTransitions = {{0,-1,102,4,103,-1},{0,-1,101,7,102,-1},{0,-1,114,8,115,-1},{0,-1,114,1,115,-1},{0,-1,111,3,112,-1},{0,-1,101,2,102,-1},{0,-1,64,0,65,-1},{0,-1,118,5,119,-1},{0,-1}};
    CharRegexTable foreverMain = new CharRegexTable(6,foreverMainTransitions,foreverMainAccepts);
    RuleData forever=new RuleData(foreverMain,null,false);
    boolean[] _breakMainAccepts = {false,false,false,false,false,false,true};
    int[][] _breakMainTransitions = {{0,-1,97,2,98,-1},{0,-1,114,4,115,-1},{0,-1,107,6,108,-1},{0,-1,98,1,99,-1},{0,-1,101,0,102,-1},{0,-1,64,3,65,-1},{0,-1}};
    ...
    int[][] _continueMainTransitions = {{0,-1,64,4,65,-1},{0,-1,116,6,117,-1},{0,-1,101,9,102,-1},{0,-1,110,1,111,-1},{0,-1,99,8,100,-1},{0,-1,117,2,118,-1},{0,-1,105,7,106,-1},{0,-1,110,5,111,-1},{0,-1,111,3,112,-1},{0,-1}};
    CharRegexTable _continueMain = new CharRegexTable(0,_continueMainTransitions,_continueMainAccepts);
    ...
    int[][] printMainTransitions = {{0,-1,112,1,113,-1},{0,-1,114,5,115,-1},{0,-1,116,6,117,-1},{0,-1,110,2,111,-1},{0,-1,64,0,65,-1},{0,-1,105,3,106,-1},{0,-1}};
    CharRegexTable printMain = new CharRegexTable(4,printMainTransitions,printMainAccepts);
    ...
    int[][] printlnMainTransitions = {{0,-1,108,2,109,-1},{0,-1,105,7,106,-1},{0,-1,110,8,111,-1},{0,-1,112,5,113,-1},{0,-1,64,3,65,-1},{0,-1,114,1,115,-1},{0,-1,116,0,117,-1},{0,-1,110,6,111,-1},{0,-1}};
    CharRegexTable printlnMain = new CharRegexTable(4,printlnMainTransitions,printlnMainAccepts);
    RuleData println=new RuleData(printlnMain,null,false);
    boolean[] _nullMainAccepts = {false,false,false,false,false,true};
    int[][] _nullMainTransitions = {{0,-1,76,4,77,-1},{0,-1,85,0,86,-1},{0,-1,78,1,79,-1},{0,-1,64,2,65,-1},{0,-1,76,5,77,-1},{0,-1}};
    CharRegexTable _nullMain = new CharRegexTable(3,_nullMainTransitions,_nullMainAccepts);
    RuleData _null=new RuleData(_nullMain,null,false);
    boolean[] guiMainAccepts = {false,false,false,false,true};
    int[][] guiMainTransitions = {{0,-1,117,1,118,-1},{0,-1,105,4,106,-1},{0,-1,103,0,104,-1},{0,-1,64,2,65,-1},{0,-1}};
